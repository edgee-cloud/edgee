...
const SIZES: [i32; 24] = [
    23, 37, 52, 65, 72, 88, 92, 101, 134, 141, 144, 167, 168, 181, 195, 204, 231, 235, 256, 283,
    301, 303, 310, 322,
];
...
const CORRESPONDENCE: [[char; 38]; 24] = [
    [
        'k', 'd', 'g', 'a', 'j', 'e', 'p', '2', '5', 'y', 't', 'm', 'n', 'w', 'r', 'z', '7', 'x',
        '3', '8', 'b', '6', 'c', 'u', 'q', 'i', 's', '4', '1', '-', 'v', 'l', '9', 'h', 'o', 'f',
        '.', '0',
    ],
    [
        'b', 's', 'y', 'f', '1', 'x', '5', 'v', '3', '.', '4', 'e', 'i', '6', 'q', 'n', 'u', '8',
        'm', 'c', '0', 'd', 't', '7', 'l', 'z', 'k', 'a', '-', '2', 'r', 'o', 'j', 'w', '9', 'g',
        'h', 'p',
    ],
    [
        '-', 'x', 's', 'z', 'm', '6', '2', '8', 'f', 'i', 'y', 'o', 'b', '5', 'e', 'r', 'p', 'q',
        'n', 'h', 'u', 'c', '0', 'w', 'd', '3', 'g', 'a', '4', '1', 't', 'v', 'k', '7', 'j', '.',
        '9', 'l',
    ],
    [
        '3', 'l', 'r', 'a', 'i', 'j', 'q', 'y', 'c', 'b', 'f', 'n', 'e', 'v', '2', '6', '4', 'u',
        '7', 'o', '5', '9', 'z', 'k', 's', '.', 'd', 'p', 'w', '0', '8', 'g', '1', 'x', '-', 'm',
        'h', 't',
    ],
    [
        'n', 'r', 'm', '4', '3', '7', 'g', 'a', 'u', 'o', 'p', '9', 'i', 'd', 's', 'j', 'v', 'w',
        '8', 'f', '5', 'x', '6', 'k', 'y', 'z', 'q', '.', 'l', '1', '2', 'e', '0', 'h', 't', 'b',
        '-', 'c',
    ],
    [
        'j', '-', 'y', 'i', '7', 'c', '4', '9', 'u', 'f', '8', 'z', 'd', 'q', '3', 'r', 'e', 'o',
        '6', 'h', 'v', 'k', 'b', '1', 'g', 'm', '.', 'n', 'l', 't', 'w', 'x', 'p', 's', '0', '2',
        'a', '5',
    ],
    [
        'o', 'p', 'g', 'e', 'u', '9', 'f', 't', 'a', 'q', 'b', 'r', 'x', '2', '8', '1', 'n', 'c',
        '6', 'h', 'l', '5', '-', 's', 'z', '3', '7', 'v', 'y', '4', '.', 'm', 'd', 'i', 'k', 'w',
        'j', '0',
    ],
    [
        'w', 'g', 'i', 'm', '3', 'r', '2', 's', 'a', 'b', '8', 'c', '5', 'h', 'e', 'y', '9', 'p',
        'k', 'd', 'l', 'j', 'q', 'u', '0', 'v', '.', '-', 't', '6', 'z', 'x', 'n', '7', 'f', '4',
        'o', '1',
    ],
    [
        '1', '2', 'k', 'e', 'l', 'c', 'x', 'z', 's', '-', 'a', 'y', '8', '9', '5', 'v', 'n', '6',
        'h', '0', '3', 'j', 'i', '7', 'g', 'q', '4', 'u', 'd', 'p', '.', 'o', 'r', 'w', 'b', 't',
        'f', 'm',
    ],
    [
        '5', '3', 'g', 'f', 'p', 'u', 'k', 'w', '8', 'e', '2', 'y', 'l', 'm', 'j', 's', 'b', '7',
        '4', 't', 'x', 'i', 'd', '0', 'z', '-', 'h', '6', 'o', '.', 'c', '9', 'n', '1', 'q', 'a',
        'v', 'r',
    ],
    [
        '1', 'k', 'e', '5', '9', 'x', 'h', 'g', '2', 'v', 'j', 'm', 'f', '4', '.', 'p', 'b', 'q',
        '7', 'l', 'r', 'i', 'a', '8', 'y', 'z', 'c', '0', 'n', 't', '3', '6', '-', 'd', 'o', 'w',
        's', 'u',
    ],
    [
        '8', 'v', 'b', 'q', 'k', '.', 'y', 'a', '5', 'c', 'n', 'g', '2', '0', 'd', 'j', 'l', '9',
        'm', 'e', 'r', 'i', '3', 'x', '6', 's', 'w', '4', 'h', 'o', 'f', 't', '-', '1', 'u', 'p',
        'z', '7',
    ],
    [
        'w', '0', '6', 'k', 'j', '3', 'c', 'b', 't', '7', 'o', '-', 'e', '5', '9', 'd', 'n', 'y',
        'x', 'v', 'q', 'i', 'z', 'l', 'f', 'a', '4', 'p', '8', 'h', '.', 'g', '1', 'u', '2', 'm',
        's', 'r',
    ],
    [
        '7', 'x', 'n', 'l', 'r', 'z', 'u', 'a', 'v', 'e', 'd', '1', 'y', '2', 'c', '3', '4', '.',
        'k', 'h', 't', 'i', 'f', '6', '-', 'j', 'w', 'o', '0', 'm', '8', 'g', 'b', 's', 'q', 'p',
        '9', '5',
    ],
    [
        'd', '1', 's', 'g', '3', '6', 'v', 'n', 'f', 'q', 'w', 'b', '0', 'k', 'c', '5', 'e', '2',
        'h', 'p', 'i', 'y', 'j', '4', 't', '9', 'm', 'u', '7', '.', '8', 'r', 'o', 'a', 'x', 'z',
        '-', 'l',
    ],
    [
        'c', '2', '7', 'n', 'z', 'm', 'x', 'h', 'i', 'v', '0', '.', 'u', 'g', 'l', '9', 'w', 'b',
        'p', 'y', 'e', 'o', '5', 'f', '-', '8', '4', '1', 'q', 'k', 'a', 'd', 's', '3', 'j', 'r',
        't', '6',
    ],
    [
        '2', '0', 'q', '5', 'i', 't', 'h', '9', 'l', 'd', 'u', '6', '-', 'z', 'v', '7', 'x', 'w',
        'g', 'c', 'a', '3', 'r', 'e', 'k', 'm', '8', 'b', 'n', '.', 'y', 's', '4', 'j', 'o', 'f',
        'p', '1',
    ],
    [
        '2', 'y', '1', 'z', 'p', '6', 'm', 'u', 'v', 'k', '-', 'd', 'f', 'i', 'g', 'n', 'l', '3',
        'q', 'e', 'o', 'r', '0', 'j', '5', 'w', 's', 'h', 'c', 't', 'a', '.', '8', '9', '4', 'b',
        '7', 'x',
    ],
    [
        '6', 'e', 'j', 'y', '2', 'b', 'g', '8', 'l', '9', 'z', 'w', 's', 'i', 'h', 'x', 'v', 'm',
        'a', '1', '7', '5', 'u', '.', 'r', 'n', '3', '-', 'k', '0', 'c', 'd', 't', 'q', 'p', 'o',
        'f', '4',
    ],
    [
        'w', 'y', 's', '8', 'm', 'b', 'r', 'p', '0', 'k', '4', '9', 'f', 'h', '5', 'x', 'c', 'd',
        't', 'i', 'g', 'e', 'q', '-', '3', 'o', 'u', 'a', 'z', '2', '.', 'n', 'v', 'l', 'j', '1',
        '6', '7',
    ],
    [
        '8', 's', 'm', '1', '7', 'd', 'y', '0', 'p', 't', '.', '3', 'u', 'q', 'j', 'w', '-', '4',
        'x', 'e', 'a', '9', 'o', 'c', 'r', 'h', 'g', 'k', 'v', '6', 'n', '2', 'f', 'z', 'i', 'l',
        'b', '5',
    ],
    [
        'j', 'm', 'k', '9', '4', 'g', 'q', 'd', 'x', 'w', 'y', 'v', '3', 'b', 'c', 'f', '5', '6',
        '2', 'p', 'e', 'a', 'n', 'i', 't', 'z', '-', '1', 'o', 'l', '8', 'h', 'r', '.', '7', '0',
        'u', 's',
    ],
    [
        '9', '4', 'g', 'z', 'r', '-', 'u', 'o', '.', 'x', '7', 'd', 'w', '3', 't', 'n', 's', 'f',
        'l', '1', '2', 'k', 'y', 'i', '0', '5', 'c', 'p', 'j', 'b', 'm', '6', 'a', 'v', '8', 'e',
        'h', 'q',
    ],
    [
        'n', '6', 'o', 'k', 'l', 't', '3', 'a', 'f', 'y', '5', '7', 'm', 'q', 'p', '.', '1', 'e',
        'd', 'c', '-', 'u', '4', 's', 'g', 'v', '8', 'r', '0', 'b', '2', 'x', 'z', 'j', '9', 'w',
        'i', 'h',
    ],
];
