...
use crate::data_collection::versions::v1_1_0::data_collection::exports::edgee::components1_1_0::data_collection as DataCollection1_1_0;

impl From<payload::Event> for DataCollection1_1_0::Event {
    fn from(value: payload::Event) -> Self {
        let data = match value.data {
            payload::Data::Page(page) => DataCollection1_1_0::Data::Page(page.into()),
            payload::Data::User(user) => DataCollection1_1_0::Data::User(user.into()),
            payload::Data::Track(track) => DataCollection1_1_0::Data::Track(track.into()),
        };
        let consent = match value.consent {
            Some(payload::Consent::Pending) => Some(DataCollection1_1_0::Consent::Pending),
            Some(payload::Consent::Granted) => Some(DataCollection1_1_0::Consent::Granted),
            Some(payload::Consent::Denied) => Some(DataCollection1_1_0::Consent::Denied),
            None => None,
        };
        Self {
            uuid: value.uuid,
...
impl From<payload::EventType> for DataCollection1_1_0::EventType {
...
impl From<payload::Page> for DataCollection1_1_0::PageData {
...
impl From<payload::User> for DataCollection1_1_0::UserData {
...
impl From<payload::Track> for DataCollection1_1_0::TrackData {
...
impl From<payload::Context> for DataCollection1_1_0::Context {
...
impl From<payload::Campaign> for DataCollection1_1_0::Campaign {
...
impl From<payload::Client> for DataCollection1_1_0::Client {
...
impl From<payload::Session> for DataCollection1_1_0::Session {
