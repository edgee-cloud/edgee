...
use crate::data_collection::versions::v1_1_0::data_collection::exports::edgee::components1_1_0::data_collection as Component1_1_0;
...
pub async fn get_edgee_request(
    ...
    let instance = match component_ctx
        .get_data_collection_1_1_0_instance(&cfg.id, store)
        .await
    {
    ...
    let component = instance.edgee_components1_1_0_data_collection();
    ...
    let method = match request.method {
        Component1_1_0::HttpMethod::Get => "GET",
        Component1_1_0::HttpMethod::Put => "PUT",
        Component1_1_0::HttpMethod::Post => "POST",
        Component1_1_0::HttpMethod::Delete => "DELETE",
    }
    .to_string();
